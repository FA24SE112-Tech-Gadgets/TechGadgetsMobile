...
export default function ChooseLocation({
    ...
    const handleChooseLocation = async () => {
        ...
        handleChangeAddress(arrAddress[0]);

        setSnackbarMessage(t("update-new-address-success"));
        setSnackbarVisible(true);

        await delay(500);
        handleChangeModal("address", false);
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Pressable style={{
                            ...
                            disabled={arrAddress.length === 0 || address === arrAddress[0] || isNotFound || isFetching ? true : false}
                        >
                            <Text style={{
                                color: arrAddress.length === 0 || address === arrAddress[0] || isNotFound || isFetching ? "#999999" : "white"
                            }}>
                            ...
                            </Text>
                            {
                                ...
                                <ActivityIndicator color={
                                    arrAddress.length === 0 || address === arrAddress[0] || isNotFound ? "#999999" : "white"
                                } />
                            }
                        </Pressable>
                    </View>
