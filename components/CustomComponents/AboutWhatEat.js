...
const AboutWhatEat = () => {
  ...
  const teamData = [
    {
      avaURL: kietPic,
      jobTitle: "CEO WhatEat",
      intro: t("ptk-intro"),
      introContent: t("ptk-intro-content")
    },
    {
      avaURL: dungPic,
      jobTitle: "Co-Founder WhatEat",
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      >
        ...
        >
          <FontAwesome6 name="people-group" color={"#FB6562"} size={ScreenWidth / 20} />
          <Text
        ...
        <View
          style={{ flexDirection: "row", alignItems: "center", columnGap: 6, paddingHorizontal: 14 }}
        >
          <Icon name="shield" type="entypo" color={"#FB6562"} />
          <Text
            style={{ fontWeight: "bold", fontSize: 18, marginVertical: 10 }}
          >
            {t("what-eat-mission")}
        ...
        <View
          style={{ flexDirection: "row", alignItems: "center", columnGap: 6, paddingHorizontal: 14 }}
        >
          <Icon name="eye" type="font-awesome-5" color={"#FB6562"} />
          <Text
            style={{ fontWeight: "bold", fontSize: 18, marginVertical: 10 }}
          >
            {t("what-eat-vision")}
        ...
        <View
          style={{ flexDirection: "row", alignItems: "center", columnGap: 6, paddingHorizontal: 14 }}
        >
          <Icon name="question" type="octicon" color={"#FB6562"} />
          <Text
            style={{ fontWeight: "bold", fontSize: 18, marginVertical: 10 }}
          >
            {t("why-us")}
