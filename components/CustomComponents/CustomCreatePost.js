...
import ImageCreateSlider from "./ImageCreateSlider";
          ...
          >
            ...
            >
              ...
              <View style={{ rowGap: 3 }}>
                ...
                <Pressable
                  ...
                  onPress={pickImage}
                >
                  <Entypo name="plus" size={ScreenWidth / 20} color={"#FB6562"} />
                  <Text style={{ color: "#FB6562", fontSize: ScreenWidth / 25 }}>{t("img")}</Text>
                  <Feather name="image" size={ScreenWidth / 20} color={"#FB6562"} />
                </Pressable>
              </View>
            </View>
            ...
            <View style={{
              ...
              <Pressable
                ...
                disabled={isFetching}
              >
                <Text style={{ fontSize: ScreenWidth / 28, color: "#FB6562", fontWeight: "500" }}>{t("post-btn")}</Text>
                {
                  isFetching &&
