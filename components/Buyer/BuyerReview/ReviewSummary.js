...
const ReviewSummary = ({ gadgetId, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.barContainer}>
        {renderBar(summary.numOfFiveStar, "5 sao")}
        {renderBar(summary.numOfFourStar, "4 sao")}
        {renderBar(summary.numOfThreeStar, "3 sao")}
        {renderBar(summary.numOfTwoStar, "2 sao")}
        {renderBar(summary.numOfOneStar, "1 sao")}
      </View>
    </View>
  );
};
